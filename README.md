...
binary media files at all.** The repository tracks 85 QA screenshots as visual
evidence under `artifacts/qa/screens/`; they are generated by this project's own
renderer, have a ledger row, and are never copied into `dist/`. The only
